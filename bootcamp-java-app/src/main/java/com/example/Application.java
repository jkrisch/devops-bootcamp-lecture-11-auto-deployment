...
public class Application {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(System.getenv("DB_SERVER"));
    ...
    public void init()
    {
        ...
        log.info(System.getenv("DB_USER"));
        log.info(System.getenv("DB_PWD"));
        log.info(System.getenv("DB_SERVER"));
        log.info(System.getenv("DB_NAME"));
